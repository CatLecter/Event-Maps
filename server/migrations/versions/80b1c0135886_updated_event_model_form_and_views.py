...
def upgrade():
    ...
    op.alter_column('event', 'creator_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.alter_column('event', 'creator_login',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('event', sa.Column('date_start', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    op.add_column('event', sa.Column('date_end', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
