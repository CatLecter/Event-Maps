...
def upgrade():
    ...
    op.create_index(op.f('ix_event_create_date'), 'event', ['create_date'], unique=False)
...
def downgrade():
    ...
    op.add_column('event', sa.Column('path_to_avatar', sa.VARCHAR(), autoincrement=False, nullable=True))
